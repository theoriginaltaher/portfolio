        ...
        <article key={project.slug} className="group grid gap-0 py-8 md:grid-cols-[0.78fr_1.22fr] md:py-0">
          <div className="flex flex-col justify-between py-3 md:min-h-[440px] md:border-r md:border-white/[0.07] md:py-10 md:pr-10">
            <div>
              ...
              <h2 className="mt-8 max-w-lg balanced text-[clamp(2rem,4vw,4rem)] font-black leading-[0.96] tracking-[-0.035em] text-white transition-colors duration-300 group-hover:text-[#e7e9ed]">{project.title}</h2>
            ...
            <div className="mt-9">
              ...
              <div className="mt-6 flex items-center justify-between border-t border-white/8 pt-4 text-xs">
                ...
                <Link href={`/projects/${project.slug}`} className="font-bold text-white transition-colors hover:text-[var(--red)]">Open case study <span className="arrow-shift" aria-hidden="true">→</span></Link>
              </div>
            </div>
          </div>
