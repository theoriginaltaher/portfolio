  ...
  return (
    <section className="border-b hairline py-14 md:py-20" id="signal">
      <div className="site-shell grid-field flex min-h-[300px] items-center justify-center py-10 md:min-h-[380px] md:py-16">
        <article className="interactive-lift w-full max-w-3xl overflow-hidden border border-[var(--border-strong)] bg-[#101010]">
          ...
          <div className="grid md:grid-cols-[minmax(0,1fr)_170px]">
            <div className="p-5 md:p-7">
              ...
              <Link href={`/blog/${post.slug}`} className="pressable mt-6 inline-flex min-h-9 items-center bg-[var(--red)] px-4 text-[9px] font-black uppercase tracking-[0.16em] text-white hover:bg-[#9e1c1c]">Read Signal</Link>
            </div>
